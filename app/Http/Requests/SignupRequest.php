...
class SignupRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email'        => ['nullable', 'string', 'max:255', Rule::unique("users", "email")->whereNull('deleted_at')->where('is_guest', Ask::NO)],
            ...
            'referral_code' => [
                ...
                'string',
                'max:255',
                Rule::exists('users', 'my_referral_code')->whereNull('deleted_at')
            ],
