...
use App\Http\Controllers\Frontend\OrderRatingController;
...
Route::prefix('frontend')->name('frontend.')->middleware(['installed', 'apiKey', 'localization'])->group(function () {
    ...
    Route::get('/favorite/getAll', [FavoriteController::class, 'getFavorites']);
    ...
    Route::prefix('order')->name('order.')->middleware(['auth:sanctum'])->group(function () {
        ...
        Route::post('/check-address-zone', [FrontendOrderController::class, 'checkAddressZone']);
        ...
        Route::get('/areas', [FrontendOrderController::class, 'areas']);
    });

    Route::prefix('offer')->name('offer.')->group(function () {
        Route::get('/', [FrontendOfferController::class, 'index'])->name('index');
